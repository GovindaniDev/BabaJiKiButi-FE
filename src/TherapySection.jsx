...
const TherapySection = () => {
 ...
 const services = [
    {
      icon: "/images/th-img1.png",
      title: 'Tailor-Made Ayurvedic Therapy',
      description: 'Benefit from two specialised therapy sessions per day, designed for your unique health condition.'
    },
    {
      icon: "/images/th-img2.png",
      title: 'Personalised Medications',
      description: 'Receive Ayurvedic medicines that target and address all your relevant health issues.'
    },
   {
      icon: "/images/th-img3.png",
      title: 'Supplements and Vitamins',
      description: 'If necessary, incorporate supplements & vitamins into your regimen to support overall well-being.'
    },
    {
      icon: "/images/th-img4.png",
      title: '24/7 Professional and Compassionate Care',
      description: 'Receive constant, high-quality care in a warm and supportive environment.'
    },
    {
      icon: "/images/th-img5.png",
      title: 'Physiotherapy and Exercise',
      description: 'Engage in a Personalised physiotherapy and exercise session tailored to your current recovery status.'
    },
    {
      icon: "/images/th-img6.png",
      title: 'Personalised Yoga',
      description: 'Explore the potential benefits of personalised yoga sessions to aid in your recovery.'
    },
    {
      icon: "/images/th-img7.png",
      title: 'Tailor-Made Diet',
      description: 'Embrace a diet plan, meticulously crafted, to align with your unique health parameters and needs.'
    },
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            >
              ...
              <motion.div
                ...
                whileTap={{ scale: 0.98 }}
                className="relative w-96 h-96 rounded-xl shadow-xl overflow-hidden cursor-pointer"
              >
                {/* Placeholder for the therapy image */}
                <div className="w-96 h-80 bg-gradient-to-br from-orange-100 to-amber-100 flex items-center justify-center">
                  <div className="text-center p-8">
                    <div className="w-96 h-32 bg-orange-200 rounded-full mx-auto mb-4 flex items-center justify-center">
                     <img src="/images/th-bg.png" alt="" className='rounded-lg' />
                    </div>
        ...
        <div className="max-w-7xl mx-auto">
          <motion.div variants={itemVariants} className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-3xl font-semibold mx-auto">
              Tailor-Made Ayurvedic Therapy में सिर्फ बीमारी नहीं देखी जाती, बल्की body की पूरी picture समझी जाती है – आपकी उम्र, पहले की medical history, lifestyle, diet और emotional state.
            </p>
          </motion.div>
          ...
          <div className="flex items-center justify-center max-w-7xl mx-auto">
            ...
            <motion.div 
              variants={containerVariants} 
              className="flex-1 space-y-8 pr-8"
            >
              {services.slice(0, 4).map((service, index) => (
                ...
                >
                  <motion.div 
                    className="flex-shrink-0 text-[#d4af87]"
                    whileHover={{ scale: 1.1, rotate: 5 }}
                    transition={{ type: "spring", stiffness: 300 }}
                  >
                    <img src={service.icon} alt="" className='w-50 h-50' />
                  </motion.div>
            ...
            {/* Center Line */}
            <motion.div 
              className="w-px h-300 bg-gradient-to-b from-transparent via-[#d4af87] to-transparent flex-shrink-0"
              initial={{ scaleY: 0 }}
            ...
            <motion.div 
              variants={containerVariants} 
              className="flex-1 space-y-8 pl-8"
            >
  ...
  whileInView="visible"
  viewport={{ once: true, amount: 0.2 }}
  className="flex justify-center w-full mb-16"          // ← centres grid on page
>
  <div className="grid md:grid-cols-5 gap-6 items-center">
    {healthCategories.map((cat, i) => (
      ...
      >
        {/* icon */}
        <div className="w-50 h-50 rounded-full flex items-center justify-center mb-2 transition">
          <img src={cat.icon} alt="" className="w-50 h-50 rounded-full object-cover" />
        </div>

        {/* title */}
        <h3 className="text-xs sm:text-sm font-semibold text-center text-gray-800 group-hover:text-orange-600 transition-colors">
          {cat.name}
        </h3>
      </motion.div>
    ))}
  ...
  <div className='grid md-cols-1 md:grid-cols-5 gap-6 items-center'>
          ...
          >
            ...
            <div className="relative z-10 max-w-2xl w-full space-y-6 font-semibold">
              ...
              <h2 className="text-3xl md:text-5xl font-bold text-orange-950">
               Life-long health कैसे maintain हो
              </h2>
